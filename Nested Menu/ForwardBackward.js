...
([
  {
    ...
    "args0": [
      {
        "type": "field_dropdown",
        // "ForwardBackwardName" is in javascript.javascriptGenerator.forBlock{}
        "name": "ForwardBackwardName",
        "options": [
          [
            "forward",
            "MoveForwardName"
...
javascript.javascriptGenerator.forBlock['typeForwardBackward'] = function(block, generator) {
  var dropdown_forwardbackward = block.getFieldValue('ForwardBackwardName');
